...
func NewImageBuildDialog() *ImageBuildDialog { //nolint:maintidx
	...
	buildDialog.pullPolicyField.SetFocusedStyle(ddselectedStyle)
	...
	buildDialog.formatField.SetFocusedStyle(ddselectedStyle)
	...
	buildDialog.networkField.SetFocusedStyle(ddselectedStyle)
